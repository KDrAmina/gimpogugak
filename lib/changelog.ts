...
export const CHANGELOG: ChangelogEntry[] = [
  ...
  // ────────────────────────────────────────────────────────────────────────
  {
    ...
    changes: [
      ...
      "[통계] 차트 YoY(Year-over-Year) 연도별 겹쳐보기 토글 기능 추가: 전체 기간 선택 시 [누적 보기 / 연도별 겹쳐보기] 전환 가능",
      "[통계] YoY 겹쳐보기 — 매출 추이: X축 1~12월 고정, 2023~2026 연도별 총매출 선 겹쳐 표시",
      "[통계] YoY 겹쳐보기 — 외부수입 트렌드: X축 1~12월 고정, 연도별 외부수입 합계 선 겹쳐 표시",
      "[통계] YoY 겹쳐보기 — 신규 유입 추이: X축 1~12월 고정, 연도별 신규 유입 수 선 겹쳐 표시",
    ],
  },
  {
    version: "5.4.0",
